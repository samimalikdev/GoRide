...
class AboutAppPage extends StatelessWidget {
          ...
          children: [
            ...
            Center(
              child: Text(
                ...
                style: GoogleFonts.poppins(color: const Color(0xff76eb07), fontSize: 13, fontWeight: FontWeight.w600),
              ),
            ),
            ...
            Center(
              child: Text(
                ...
                style: GoogleFonts.poppins(color: Colors.white54, fontSize: 13, height: 1.5),
              ),
            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: GoogleFonts.poppins(color: const Color(0xff76eb07), fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 1),
                            ),
                            Text(
                              "Sami Malik",
            ...
            _buildAboutCard(
              ...
              onTap: () => showLicensePage(
                context: context,
                applicationName: "GoRide Pakistan",
  ...
  Widget _buildSkillChip(String label) {
    return Container(
      ...
      child: Text(
        label,
        style: GoogleFonts.poppins(color: const Color(0xff76eb07), fontSize: 11, fontWeight: FontWeight.w600),
      ),
    );
  }
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(url, style: GoogleFonts.poppins(color: Colors.white38, fontSize: 11), maxLines: 1, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),
            Container(
              ...
              child: Text(
                "COPY",
                style: GoogleFonts.poppins(color: const Color(0xff76eb07), fontSize: 10, fontWeight: FontWeight.w700),
              ),
            ),
          ],
        ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Text(content, style: GoogleFonts.poppins(color: Colors.white70, fontSize: 13, height: 1.5)),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
